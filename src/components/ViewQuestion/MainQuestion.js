...
function MainQuestion(){
    ...
    //         }else{
    //             await axios
    //     .post("http://localhost:4000/answer/create",body,{
    //         headers:{ accesstoken: localStorage.getItem("token"),
    //  }
    //     } )
    //     .then(() => {
        ...
        <div className="main">
            <div className="main-container">
                ...
                <div className="all-questions">
                    ...
                    <button type="submit" style={{maxWidth:"fit-content", marginTop:"100px"}}>Post your answer</button>            
        </div>
    )
                    }
}
